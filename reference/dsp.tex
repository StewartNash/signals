...
\begin{equation}
	|e[n]|^2=s^*[n]s[n]+s^*[n]\mathbf{h}^T\mathbf{x}+\mathbf{h}\mathbf{x}^*d[n]+\mathbf{h}\mathbf{x}^*\mathbf{h}^T\mathbf{x}
\end{equation}
...
\begin{equation}
	\varepsilon(\mathbf{h})=R_{ss}[0]+\mathbf{v}^\dagger\mathbf{h}+\mathbf{h}\mathbf{v}+\mathbf{h}\mathbf{T}\mathbf{h}
\end{equation}
